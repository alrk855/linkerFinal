...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-background text-foreground relative">
      <main className="flex-1 w-full flex flex-col lg:flex-row relative z-10 min-h-[85vh]">
        ...
        <section className="flex-1 flex flex-col justify-center items-center lg:items-end px-8 sm:px-16 lg:px-24 py-24 lg:py-0 text-center lg:text-right">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground mb-6 max-w-xl mx-auto lg:mr-0 lg:ml-auto">
            {t("company_heading")}
          </h1>
          <p className="text-foreground-muted text-lg max-w-md mx-auto lg:mr-0 lg:ml-auto mb-10 leading-relaxed">
            {t("company_subtext")}
          </p>
          <div className="flex flex-col items-center lg:items-end gap-4 w-full sm:w-auto lg:mr-0 lg:ml-auto">
            <Link 
      ...
      <div className="w-full text-center pb-12 relative z-10">
        <Link href="/auth/signin" className="text-sm font-medium text-foreground hover:text-accent underline underline-offset-4 transition-colors">
